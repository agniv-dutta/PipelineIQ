      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg max-w-2xl mx-auto leading-relaxed" style={{ color: 'rgba(245,215,142,0.65)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16">
            {[
              { icon: <BarChart3 size={36} />, title: 'Multi-Touch Attribution', desc: 'Track every campaign touchpoint in your customer journey' },
              { icon: <Brain size={36} />, title: 'AI Deal Scoring', desc: 'Predict which leads will close with ML-powered probability' },
              { icon: <DollarSign size={36} />, title: 'Budget Optimization', desc: 'Get data-driven budget allocation recommendations' },
            ].map((feature, i) => (
              <div
                key={i}
              ...
              >
                ...
                <p className="text-sm" style={{ color: 'rgba(245,215,142,0.55)' }}>
                  {feature.desc}
                </p>
              </div>
            ))}
