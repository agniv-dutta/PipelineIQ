        ...
        <div className="card-bottom-glow rounded-2xl p-8" style={cardBg}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 text-gold-300/50" style={{ background: 'rgba(28,16,2,0.88)' }}>Or</span>
            </div>
          </div>
          ...
          <p className="text-center text-sm text-gold-300/50 mt-6">
            ...
            <Link href="/auth/signup" className="text-gold-500 hover:text-gold-400 transition">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
